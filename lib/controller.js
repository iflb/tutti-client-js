...
class ResourceController extends TuttiController {
    constructor(duct){
        ...
        this._setMethods({
            ...
            copyProject({ project_name_from, project_name_to }) {
                    return self._callOrSend(
                            self._duct.EVENT.PROJECT_COPY,
                            { project_name_from, project_name_to }, arguments
                        );
                },
            //renameProject({ project_name_from, project_name_to }) {
            //        return self._callOrSend(
            //                self._duct.EVENT.PROJECT_RENAME,
            //                { project_name_from, project_name_to }, arguments
            //            );
            //    },
