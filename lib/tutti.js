...
class ResourceController extends TuttiController {
    constructor(duct){
        ...
        this._methods = {
            ...
            'createSession':
                ({ project_name, platform_worker_id, client_token, platform }, awaited) =>
                    this._callOrSend(this._duct.EVENT.SESSION, { command: "create", project_name, platform_worker_id, client_token, platform }, awaited),
        ...
        this.addNanotaskGroup =
            ( project_name, template_name, name, nanotask_ids, num_assignable ) => {
                return this._duct.send( this._duct.nextRid(), this._duct.EVENT.NANOTASK_GROUP_ADD, this._data({ project_name, template_name, name, nanotask_ids, num_assignable }) );
            };
        this.listNanotaskGroup =
            ( name, nanotask_ids, num_assignable ) => {
                return this._duct.send( this._duct.nextRid(), this._duct.EVENT.NANOTASK_GROUP_LIST, this._data({ name, nanotask_ids, num_assignable }) );
            };
