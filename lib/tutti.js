...
class TuttiController {
    ...
    _callOrSend(eid, args, [, accessToken, awaited ]) {
        const send = (eid, args) => {
    ...
    constructor(duct){
        ...
        this._setMethods({
            ...
            createSession({ project_name, platform_worker_id, client_token, platform, nanotask_group_ids }) {
                    return _self._callOrSend(_self._duct.EVENT.SESSION, { command: 'create', project_name, platform_worker_id, client_token, platform, nanotask_group_id }, arguments);
                },

            getTemplateNode({ target, work_session_id, node_session_id }) {
                    return _self._callOrSend(_self._duct.EVENT.SESSION, { command: 'get', target, work_session_id, node_session_id }, arguments);
                },

            setResponse({ work_session_id, node_session_id, answers }) {
                    return _self._callOrSend(_self._duct.EVENT.SESSION, { command: 'setResponse', work_session_id, node_session_id, answers }, arguments);
                },
            ...
            getNanotasks({ project_name, template_name }) {
                    return _self._callOrSend(_self._duct.EVENT.NANOTASK_GET, { project_name, template_name }, arguments);
                },
            ...
            deleteNanotasks() {
                    return _self._callOrSend(_self._duct.EVENT.NANOTASK_DELETE, { project_name, template_name, nanotask_ids }, arguments);
                },
