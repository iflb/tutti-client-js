...
class MTurkEventListener extends DuctEventListener {
    ...
    bindTuttiHandlersToDuct(self) {
        ...
        set(self._duct.EVENT.MARKETPLACE_MTURK_TUTTI_HIT_BATCH_LIST_HITS,
    ...
    constructor(duct){
        ...
        this._setMethods({
            ...
            listHITsForTuttiHITBatch({ batch_id, cached }) {
                    return self._callOrSend(self._duct.EVENT.MARKETPLACE_MTURK_TUTTI_HIT_BATCH_LIST_HITS, { batch_id, cached }, arguments);
                },
            listHITTypes() {
