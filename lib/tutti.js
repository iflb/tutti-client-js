    ...
    constructor(duct){
        ...
        this._methods = {
            ...
            'getAutomationParameterSet':
                (args) => this._callOrSend(this._duct.EVENT.REQUEST_PARAMETER_SET_GET, ['automation_parameter_set_id'], args),
            ...
            'executeAutomation':
                (args) => this._callOrSend(this._duct.EVENT.REQUEST, ['automation_parameter_set_id', 'parameters'], args),
        };
        this.loadMethods();
