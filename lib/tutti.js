...
class Duct extends ducts.Duct {
    ...
    setupHandlers(self) {
        ...
        set(self.EVENT.GET_PROJECT_SCHEME,
                (rid, eid, data) => { _hro("getProjectScheme", data); } );
        set(self.EVENT.CREATE_TEMPLATES,
                (rid, eid, data) => { _hro("createTemplates", data); } );
        set(self.EVENT.LIST_TEMPLATE_PRESETS,
                (rid, eid, data) => { _hro("listTemplatePresets", data); } );
        set(self.EVENT.LIST_TEMPLATES,
                (rid, eid, data) => { _hro("listTemplates", data); } );
        ...
        set(self.EVENT.GET_NANOTASKS,
                (rid, eid, data) => { _hro("getNanotasks", data); } );
        set(self.EVENT.UPLOAD_NANOTASKS,
                (rid, eid, data) => { _hro("uploadNanotasks", data); } );
        set(self.EVENT.DELETE_NANOTASKS,
                (rid, eid, data) => { _hro("deleteNanotasks", data); } );
        set(self.EVENT.UPDATE_NANOTASK_NUM_ASSIGNABLE,
                (rid, eid, data) => { _hro("updateNanotaskNumAssignable", data); } );
