...
class Duct extends ducts.Duct {
    ...
    setupHandlers(self) {
        ...
        set(self.EVENT.WORKPLACE_SET_RESPONSE,
                (rid, eid, data) => { _hr("setResponse", data); } );
        ...
        set(self.EVENT.MARKETPLACE_MTURK_GET_ACTIVE_CREDENTIALS,
                (rid, eid, data) => { _hm("getActiveCredentials", data); } );

        set(self.EVENT.MARKETPLACE_MTURK_SET_ACTIVE_CREDENTIALS,
                (rid, eid, data) => { _hm("setActiveCredentials", data); } );

        set(self.EVENT.MARKETPLACE_MTURK_LISTCREDENTIALS,
                (rid, eid, data) => { _hm("listCredentials", data); } );

        set(self.EVENT.MARKETPLACE_MTURK_GET_CREDENTIALS,
                (rid, eid, data) => { _hm("getCredentials", data); } );

        set(self.EVENT.MARKETPLACE_MTURK_DELETE_CREDENTIALS,
                (rid, eid, data) => { _hm("deleteCredentials", data); } );

        set(self.EVENT.MARKETPLACE_MTURK_RENAME_CREDENTIALS,
                (rid, eid, data) => { _hm("renameCredentials", data); } );

        set(self.EVENT.MARKETPLACE_MTURK_ADD_CREDENTIALS,
                (rid, eid, data) => { _hm("addCredentials", data); } );

        set(self.EVENT.MARKETPLACE_MTURK_SET_ACTIVE_SANDBOX_MODE,
                (rid, eid, data) => { _hm("setActiveSandboxMode", data); } );
...
class MTurkEventListener extends DuctEventListener {
    constructor() {
        ...
        this.getActiveCredentials = {};
        this.setActiveCredentials = {};
        this.listCredentials = {};
        this.getCredentials = {};
        this.deleteCredentials = {};
        this.renameCredentials = {};
        this.addCredentials = {};
        this.setActiveSandboxMode = {};
        //this.setSandbox = {};
        this.getHITTypes = {};
        this.createHITType = {};
    ...
    constructor(duct){
        ...
        this._setMethods({
            getActiveCredentials() {
                    return _self._callOrSend(_self._duct.EVENT.MARKETPLACE_MTURK_GET_ACTIVE_CREDENTIALS, {}, arguments);
                },
            setActiveCredentials({ credentials_id }) {
                    return _self._callOrSend(_self._duct.EVENT.MARKETPLACE_MTURK_SET_ACTIVE_CREDENTIALS, { credentials_id }, arguments);
                }, 
            listCredentials() {
                    return _self._callOrSend(_self._duct.EVENT.MARKETPLACE_MTURK_LIST_CREDENTIALS, {}, arguments);
                }, 
            getCredentials({ credentials_id }) {
                    return _self._callOrSend(_self._duct.EVENT.MARKETPLACE_MTURK_GET_CREDENTIALS, { credentials_id }, arguments);
                }, 
            deleteCredentials({ credentials_id }) {
                    return _self._callOrSend(_self._duct.EVENT.MARKETPLACE_MTURK_DELETE_CREDENTIALS, { credentials_id }, arguments);
                }, 
            renameCredentials({ credentials_id, label }) {
                    return _self._callOrSend(_self._duct.EVENT.MARKETPLACE_MTURK_RENAME_CREDENTIALS, { credentials_id, label }, arguments);
                }, 
            addCredentials({ access_key_id, secret_access_key, label }) {
                    return _self._callOrSend(_self._duct.EVENT.MARKETPLACE_MTURK_ADD_CREDENTIALS, { access_key_id, secret_access_key, label }, arguments);
                }, 
            setActiveSandboxMode({ is_sandbox }) {
                    return _self._callOrSend(_self._duct.EVENT.MARKETPLACE_MTURK_SET_ACTIVE_SANDBOX_MODE, { is_sandbox }, arguments);
                },
        });
        this._loadMethods();
    }
    ...
    constructor(duct){
        ...
        this._setMethods({
            ...
            setResponse({ work_session_id, node_session_id, answers }) {
                    return _self._callOrSend(_self._duct.EVENT.WORKPLACE_SET_RESPONSE, { work_session_id, node_session_id, answers }, arguments);
                },
