...
class ResourceController extends TuttiController {
    constructor(duct){
        ...
        this.createSession =
            ( project_name, platform_worker_id, client_token, platform ) => {
                return this._duct.send( this._duct.nextRid(), this._duct.EVENT.SESSION, this._data({ command: "create", project_name, platform_worker_id, client_token, platform }) );
            };
        this.setResponse =
        ...
        //this.getWorkerIdsForProject = {
        //        send: ( project_name ) => { return this._duct.send( this._duct.nextRid(), this._duct.EVENT.WORKER_GET_IDS_FOR_PROJECT, this._data({ project_name }) ); },
        //        call: async ( project_name ) => { return await this._duct.call( this._duct.EVENT.WORKER_GET_IDS_FOR_PROJECT, this._data({ project_name }) ); }
        //    };
        //this.getWorkerIdForPlatform = {
        //        send: ( platform, platform_worker_id ) => { return this._duct.send( this._duct.nextRid(), this._duct.EVENT.WORKER_GET_IDS_FOR_PROJECT, this._data({ platform, platform_worker_id }) ); },
        //        call: async ( project_name ) => { return await this._duct.call( this._duct.EVENT.WORKER_GET_IDS_FOR_PROJECT, this._data({ platform, platform_worker_id }) ); }
        //    };
        this.getWorkerIdsForProject =
            ( project_name ) => {
                return this._duct.send( this._duct.nextRid(), this._duct.EVENT.WORKER_GET_IDS_FOR_PROJECT, this._data({ project_name }) );
            };
        this.getWorkerIdForPlatform =
            ( platform, platform_worker_id ) => {
                return this._duct.send( this._duct.nextRid(), this._duct.EVENT.WORKER_GET_ID_FOR_PLATFORM, this._data({ platform, platform_worker_id }) );
            };
    }
